...
// ===================== SHADER COMPONENTS =====================
function ShaderPlane({ position = [0, -0.75, -0.5], planeSize = [4, 4] }) {
...
interface CPPNShaderBackgroundProps {
  className?: string;
...
export default function CPPNShaderBackground({
  ...
  return (
    <div ref={canvasRef} className={className} aria-hidden>
      <Canvas
        camera={camera}
      ...
      >
        <ShaderPlane position={planePosition} planeSize={planeSize} />
      </Canvas>
